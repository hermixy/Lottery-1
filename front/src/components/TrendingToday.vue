  ...
  data () {
    ...
    return {
      chartData: {
        ...
        rows: [
          { '类型': '昨日', 'M0': 55, 'M1': 44, 'M2': 38, 'M3': 23, 'M4': 28 },
          { '类型': '0619', 'M0': 33, 'M1': 3, 'M2': 27, 'M3': 55, 'M4': 10 },
          { '类型': '0618', 'M0': 25, 'M1': 54, 'M2': 28, 'M3': 43, 'M4': 38 },
          { '类型': '0617', 'M0': 13, 'M1': 23, 'M2': 32, 'M3': 14, 'M4': 49 },
          { '类型': '0616', 'M0': 55, 'M1': 44, 'M2': 38, 'M3': 23, 'M4': 18 },
          { '类型': '0615', 'M0': 33, 'M1': 3, 'M2': 27, 'M3': 55, 'M4': 10 }
          // { '类型': '0614', 'M0': 25, 'M1': 54, 'M2': 28, 'M3': 43, 'M4': 38 },
          // { '类型': '0613', 'M0': 13, 'M1': 23, 'M2': 32, 'M3': 14, 'M4': 39 }
        ]
      }
    }
  },
